...
After this access is granted (it takes about 30 seconds for the codespace to start), and you'll have everything you need to get started, without ever needing to install Git, Node.js, or other developer tools.
...
<div style={{ width: "100%", textAlign: "center", margin: "0 auto" }}>
  <video
    width={"300"}
    style={{ width: "100%", borderRadius: "10pt", margin: "15pt auto" }}
    muted={true}
    autoPlay={true}
    loop={true}
  >
